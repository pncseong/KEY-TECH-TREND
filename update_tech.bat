...
echo.
echo ==================================================
echo 4. Auto-uploading to GitHub...
echo ==================================================
echo Uploading latest data to GitHub...
"C:\src\Git\cmd\git.exe" add data.js data.json
"C:\src\Git\cmd\git.exe" commit -m "Auto-update tech data"
"C:\src\Git\cmd\git.exe" push origin main
